<div class="block-holder">
    ...
    <div class="wpm-control-row">
        <label><span><?php _e('Название фильтра', 'mbl_admin'); ?></span>
            <input type="text"
                   name="name"
                   required="required"
    ...
    <div class="wpm-control-row">
        <label><span><?php _e('Интервал времени', 'mbl_admin'); ?></span>
    ...
    <div class="wpm-control-row">
        <label><span><?php _e('Количество уникальных входов', 'mbl_admin'); ?></span>
            <input type="text"
                   name="entries"
                   data-integers-only
                   required="required"
    ...
    <div class="wpm-tab-footer">
        <button type="button"
                class="button button-primary wpm-save-auto-block"><?php _e('Сохранить', 'mbl_admin'); ?></button>
        <?php if ($id) : ?>
            <button type="button"
                    class="button button-danger wpm-remove-auto-block"><?php _e('Удалить', 'mbl_admin'); ?></button>
        <?php endif; ?>
    </div>
</div>
