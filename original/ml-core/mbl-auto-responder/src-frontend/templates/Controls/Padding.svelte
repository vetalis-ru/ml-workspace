...
<div class="row">
    ...
    <div class="col-right">
        ...
        {#if checked}
            ...
            <div class="root__control">
                <span style="margin-right: 10px;">Справа</span>
                <div class="number">
                    <Number value={padding.right}
                            on:change={e => { change({ right: e.detail.value }) }}
                    />
                </div>
            </div>
            <div class="root__control">
            ...
            <div class="root__control">
                <span style="margin-right: 10px;">Слева</span>
                <div class="number">
                    <Number value={padding.left}
                            on:change={e => { change({ left: e.detail.value }) }}
                    />
                </div>
            </div>
        {:else}
