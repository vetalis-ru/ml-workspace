...
class MBLCERTCore
{
    ...
    public function notActiveNotice()
    {
        ...
        $message = __('МОДУЛЬ СЕРТИФИКАТОВ не активирован!', 'mbl_admin');
    ...
    private function _pluginKeyActive()
    {
        ...
        return (bool)count(wpm_array_filter($activeKeys, 'cerificates'));
    }
    ...
    private function _run()
    {
	    mblc_register_style(
		    ...
		    mblc_plugin_assets_uri('css/certificate-shortcodes.css')
	    );
        require_once mblc_plugin_path('admin/admin.php');
        require_once mblc_plugin_path('public/frontend.php');
    }
